...
add_shortcode( 'coverage-list-posts', 'coverage_listing_shortcode1' );
function coverage_listing_shortcode1( $atts ) {
    ...
    if ( $query_research->have_posts() ) { ?>
        <div class="main-blog-listing">
            ...
            <?php endwhile;?>
	        	<?php next_posts_link( 'Older Coverage', $query_research->max_num_pages );?>
				<?php previous_posts_link( 'Newer Coverage' );?>
